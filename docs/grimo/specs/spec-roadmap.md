...
> 最後更新：2026-05-18（S197 tasks all PASS；next S197 Phase 4 consolidation + QA）
...
| S197 | 必填欄位即時提示 UX（Publish / Edit required mark + inline error，不等 submit 才顯示 native bubble） | S(8) | S176 ✅, S188 ✅, S195 ✅ | ⏳ Dev — T01/T02/T03/T04 PASS 2026-05-18；next Phase 4 consolidation + QA |
