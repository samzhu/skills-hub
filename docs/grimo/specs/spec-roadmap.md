...
| Phase 4 | M90e2: Onboarding wizard | S096e2 | S(7) split from S096e | — | 📋 planned — split from S096e; 4-step `/onboarding` wizard per prototype; POST /me/preferences endpoint; onboarding-complete flag |
