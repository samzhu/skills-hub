...
> 最後更新：2026-05-20（S204 T03 PASS；next $verifying-quality S204）
...
| S204 | OAuth Login Error Page（OAuth callback 失敗導到 `/auth/error`，不再顯示 Spring default `/login?error`） | S(5) | S139 ✅, S152 ✅ | ⏳ QA pending — T01/T02/T03 PASS；next `$verifying-quality S204` |
...
| v4.88.0 | S204 (OAuth Login Error Page) | ⏳ QA pending — T01/T02/T03 PASS；next `$verifying-quality S204` |
