...
> 最後更新：2026-05-19（S201 shipped v4.84.0）
...
| S202 | Production E2E Fixture Runner（正式 app image + `e2e/` Compose + 外部 fixture runner；移除 `/internal/test/*`） | M(14) | S140 ✅, ADR-007 superseded-by-design | ⏳ Dev — T07 BLOCKED: V07 semantic fixture requires `SKILLSHUB_E2E_GENAI_API_KEY` |
---
