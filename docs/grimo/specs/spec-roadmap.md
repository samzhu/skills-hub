...
| S162 | API response consistency — 統一 error shape (401/403/415/500) + 鎖死 JSON content negotiation | S(5) | — | 🚧 v4.35.0 partial — AC-3 415 + AC-5 500 fallback ship；剩 401/403 (SecurityConfig) / xml→406 / 409→403 sweep |
