...
> 最後更新：2026-05-17（S193 task plan created；下一輪接 S193-T01）
...
| S193 | Semantic Search Score Transparency（沿用 Spring AI score 排序；補 top-hit score logging + semantic card 相符度呈現） | XS(5) | S157 ✅, S177 ✅, S186 ✅, S189 ordering-only | ⏳ Plan — task files created；next `$planning-tasks S193` |
