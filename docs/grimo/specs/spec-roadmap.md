...
| Phase 4 | M90d2: Publish flow + new domain events + prototype design polish | S096d2 | M(10-12) | — | 📋 planned — split from S096d L; PublishPage 單頁 → /upload + /validate + /review three-step SSE; 3 new domain events (Bundle/Frontmatter/RiskScan); per-skill stats endpoint; cherry-pick prototype design polish per user mid-tick request |
