...
> 最後更新：2026-05-17（S179 T01 PASS；下一輪接 verifying-quality）
...
| S179 | Publish author anonymous login hint（未登入時作者欄位顯「請先登入後發布」，不再空白） | XS(7) | S154b ✅, S139 ✅ | ⏳ QA needed — S179-T01 PASS; next `$verifying-quality S179` |
