...
| Phase 5 | M93b2: yaml-frontmatter live validation | S099b2 | XS(3) split from S099b | — | 📋 planned — textarea 內容 parse yaml-frontmatter；缺 name / description 即 inline error；errors 直接顯示行號 |
| Phase 5 | M93b3: markdown preview pane | S099b3 | S(5) split from S099b | — | 📋 planned — PublishPage text mode 加 split-view preview；render markdown 內文部分 |
