...
| S155 | Deployment audit polish — 7 個 LAB 小 UX 問題（footer link / auth-debug / publish-failed / 文案 / 偏好 modal / sort active / CLI dropdown 死 UI）| S(7) | — | 🚧 v4.29.0 partial — 4/7 shipped (#1 footer + #3 publish-failed guard + #5 偏好 modal + #7 CLI label)；剩 3 項 |
