...
| Phase 5 | M93b: PublishPage text input mode | S099b | S(8) | — | 📋 planned — PublishPage 加 Tabs (上傳 zip / 貼上文本)；text mode → textarea + 4 metadata inputs → POST /skills JSON 或派生虛擬 zip 走既有 pipeline |
