...
| S155 | Deployment audit polish — 7 個 LAB 小 UX 問題（footer link / auth-debug / publish-failed / 文案 / 偏好 modal / sort active / CLI dropdown 死 UI）| S(7) | — | 🚧 v4.30.0 partial — 5/7 shipped (#1 + #2 + #3 + #5 + #7)；剩 #4 文案 sweep + #6 sort tab(needs-reverify) |
