...
| S176 | Explicit Publish Skill Name（發佈頁手填平台 skill name + 允許重名） | S(7) | S003 ✅, S004 ✅, S032 ✅, S154b ✅, S173 ✅ | ⏳ Plan — task files T01-T05 ready：DB unique drop、backend upload contract、version metadata decouple、PublishPage field、browser E2E |
