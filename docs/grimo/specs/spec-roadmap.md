...
> 最後更新：2026-05-19（S199 shipped v4.82.0；next `$planning-tasks S200`）
...
| S200 | Request requester display identity（需求詳情 header 不顯 `u_<id>`；request DTO 補 requesterDisplayName/requesterHandle） | XS(4) | S192 ✅, S156c ✅, S196 ✅ | ⏳ Dev — S200-T01 PASS；next `$planning-tasks S200` |
