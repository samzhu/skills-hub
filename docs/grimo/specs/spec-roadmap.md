...
> 最後更新：2026-05-17（S162b 查證後 no-op 關閉；S178 關閉並由 S189 乾淨承接；S186/S185 shipped；下一步先部署覆測 S185，再接 S187 / S188 / S189 依相依順序）
...
| S185 | Skill list/detail projection consistency（list visibility/version fields 對齊 detail） | XS(8) | S175 ✅, S177 ✅, S184 ✅ | ✅ v4.67.0 — `./scripts/verify-all.sh` exit=0；release docs archived；deploy/recheck pending as next automation unit |
