...
| Phase 4 | M90d5: /publish/validate poll + new domain events + SSE | S096d5 | M(10) split from S096d4 | — | 📋 planned — Step 2 poll page (between upload + review); 3 new domain events (Bundle/Frontmatter/RiskScan); SSE event stream backend; auto-poll on /publish/review |
