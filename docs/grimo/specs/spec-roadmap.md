...
| S155 | Deployment audit polish — 7 個 LAB 小 UX 問題（footer link / auth-debug / publish-failed / 文案 / 偏好 modal / sort active / CLI dropdown 死 UI）| S(7) | — | 🚧 v4.27.0 partial — 2/7 shipped (#1 footer + #7 CLI label)；剩 5 項分 tick 跟進 |
