...
| S202 | Production E2E Fixture Runner（正式 app image + `e2e/` Compose + 外部 fixture runner；移除 `/internal/test/*`） | M(14) | S140 ✅, ADR-007 superseded-by-design | ⏳ Release — QA PASS / local release PASS；next `$shipping-release S202` |
---
