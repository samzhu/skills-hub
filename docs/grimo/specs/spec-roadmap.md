...
> 最後更新：2026-05-18（S197 local implementation consolidated；next `$verifying-quality S197`）
...
| S197 | 必填欄位即時提示 UX（Publish / Edit required mark + inline error，不等 submit 才顯示 native bubble） | S(8) | S176 ✅, S188 ✅, S195 ✅ | ⏳ QA — local implementation PASS 2026-05-18；S197 task files consolidated/deleted；next `$verifying-quality S197` |
