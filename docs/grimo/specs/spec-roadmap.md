...
| Phase 4 | M92b: Publish Failures `/publish/failed` page | S098b | S(8) | — | 📋 planned — prototype #7 State A frontmatter error + State B high-risk submit-for-review |
...
| Phase 4 | M92d: Homepage v2 polish | S098d | S(8) | — | 📋 planned — 3-column grid xl breakpoint; sort chips; risk filter sidebar (prototype #2) |
| Phase 4 | M92e: Skill Detail v2 polish | S098e | S(8-9) | — | 📋 planned — 5-tab structure (Overview/Risk/Versions/Reviews/Flags); download sparkline hero strip (prototype #3) |
| Phase 4 | M92f: Docs IA expansion | S098f | M(10) | — | 📋 planned — 3-4 docs pages (Overview/SKILL.md spec/Frontmatter/Bundle/Risk tiers) per prototype #16 sidebar IA |
| Phase 4 | M92g: i18n 繁中化 audit | S098g | M(10) | — | 📋 planned — P0；user mid-tick directive；Landing/Notifications/Docs/HomePage 等 ~60-80 英文 user-facing 字串改繁中 per CLAUDE.md「UI 語言: 繁體中文」 |
| Phase 4 | M92h: YourFirstSkillPage 配色對比修復 | S098h | S(6) | — | 📋 planned — P0；user 截圖 mid-tick；卡片/inputs/code-blocks 在 dark theme 上 black-on-black；改用 v2 dark `--card` token + `--ink/8` border |
