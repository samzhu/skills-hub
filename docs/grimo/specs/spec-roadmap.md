...
| S192 | 作者顯示名稱一致性收斂（全 repo 掃掉 user-facing raw `u_<id>`；補 PublishReview、semantic result cards、reviews/comments 等漏網路徑與 API display 欄位） | M(13) | S154 ✅, S154b ✅, S177 ✅, S186 ✅ | ⏳ Dev — T02 PASS；next `$planning-tasks S192` |
