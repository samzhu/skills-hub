...
> 最後更新：2026-05-21（S205 QA PASS；next $shipping-release S205）
...
| S205 | Download filename UTF-8 Content-Disposition（中文顯示名稱下載檔名不再落成 `download`） | XS(8) | S061 ✅, S176 ✅, S188 ✅ | ✅ QA PASS / ready-to-ship — `verify-release.sh` PASS；AC-S205-5 post-release evidence deferred |
---
...
| v4.89.0 | S205 (Download Filename UTF-8 Content-Disposition) | ✅ QA PASS / ready-to-ship — `verify-release.sh` PASS；production curl/log evidence post-release |
