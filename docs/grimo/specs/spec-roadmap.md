...
> 最後更新：2026-05-18（S189 shipped v4.75.0；Release Completeness Gate clean）
...
| S194 | SKILL.md frontmatter official-format compatibility（`allowed-tools` list / `metadata.tags` array 相容匯入；非官方格式 warning + VALIDATION 扣分；nested object 仍擋） | S(10) | S135a ✅, S187 ✅ | 📐 in-design |
