...
> 最後更新：2026-05-19（S199 QA PASS；next `$shipping-release S199`）
...
| S199 | Publish Failed Actionable Validation Copy（失敗頁第一屏顯示具體原因、行數/欄位與下一步，不只顯示 generic validation failed） | XS(4) | S098b ✅, S098b3-2 ✅, S195 ✅ | ⏳ Release — QA PASS 2026-05-19；next `$shipping-release S199` |
