...
| S187 | Skill SKILL.md 編輯頁（詳情頁 edit 導向 `/skills/{id}/edit`；版本頁籤只顯示紀錄；description 來自 latest SKILL.md） | M(13) | S142a ✅, S163 ✅, S176 ✅, S186 ✅, S188 ordering-only | ⏳ Dev — T01 PASS；next `$planning-tasks S187` starts T02 |
