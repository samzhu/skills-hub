...
| Phase 4 | M90d4: Publish flow restructure + new domain events | S096d4 | M(10-12) | — | 📋 planned — split from S096d3; PublishPage 單頁 → /upload + /validate + /review three-step SSE; 3 new domain events (SkillBundleExtracted / SkillFrontmatterValidated / SkillRiskScanStarted) |
