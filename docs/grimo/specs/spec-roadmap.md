...
> 最後更新：2026-05-21（S204 shipped v4.88.0；S205 local header contract PASS；next $verifying-quality S205）
...
| S205 | Download filename UTF-8 Content-Disposition（中文顯示名稱下載檔名不再落成 `download`） | XS(8) | S061 ✅, S176 ✅, S188 ✅ | ⏳ QA pending — AC-S205-1~4 local header contract PASS；AC-S205-5 post-release evidence deferred |
---
...
| v4.89.0 | S205 (Download Filename UTF-8 Content-Disposition) | ⏳ QA pending — local `filename*` header contract PASS；production curl/log evidence post-release |
...
| S204 | OAuth Login Error Page | M(13) | v4.88.0 |
