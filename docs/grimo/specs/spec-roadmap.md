...
> 最後更新：2026-05-08（+ S159 query API hardening — category / tag / 拒收未知 param）
...
| S155 | Deployment audit polish — 6 個 LAB 小 UX 問題（footer link / auth-debug / publish-failed / 文案 / 偏好 modal / sort active 不同步）| S(6) | — | 📐 in-design |
