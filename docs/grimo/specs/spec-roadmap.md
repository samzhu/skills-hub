...
> 最後更新：2026-05-20（S204 QA blocked：verify-release V07b FAIL；next $verifying-quality S204）
...
| S204 | OAuth Login Error Page（OAuth callback 失敗導到 `/auth/error`，不再顯示 Spring default `/login?error`） | S(5) | S139 ✅, S152 ✅ | ⏳ QA blocked — T01/T02/T03 PASS；`verify-release.sh` V07b FAIL；next `$verifying-quality S204` |
...
| v4.88.0 | S204 (OAuth Login Error Page) | ⏳ QA blocked — T01/T02/T03 PASS；`verify-release.sh` V07b FAIL；next `$verifying-quality S204` |
