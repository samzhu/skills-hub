...
> 最後更新：2026-05-19（S198 QA PASS；next `$shipping-release S198`）
...
| S198 | SKILL.md Recommendations Not Hard Errors（官方建議不擋 upload；500 行等 best practice 轉 warning + quality 扣分） | XS(5) | S135a ✅, S194 ✅ | ✅ QA PASS 2026-05-19；next `$shipping-release S198` |
