...
> 最後更新：2026-05-15（S176 in-design — explicit publish skill name）
...
| S176 | Explicit Publish Skill Name（發佈頁手填平台 skill name + 允許重名） | S(7) | S003 ✅, S004 ✅, S032 ✅, S154b ✅, S173 ✅ | 📐 in-design — platform `skills.name` 改由 multipart `skillName` 取得；drop `skills.name` unique；`SKILL.md name` 僅保留為 package metadata |
