  ...
  return (
    <DocsLayout>
      ...
      <ol className="mt-2 list-decimal space-y-1 pl-5 text-[14px] text-[#A8A49C]">
        <li><strong className="text-[#EEECEA]">YAML frontmatter</strong> — 以 <code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">---</code> 包夾的 metadata 區塊，宣告 name / description / 版本等</li>
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5 text-[14px] text-[#A8A49C]">
        <li>檔名必須為 <code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">SKILL.md</code>（大小寫敏感）</li>
        <li>frontmatter 必填：<code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">name</code>、<code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">description</code></li>
        <li>name 為 <code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">[a-z0-9-]</code> + ≤64 字元；同 org 內 unique</li>
      ...
      <P>
        ...
        頁說明 <code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">scripts/</code>、
        <code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">references/</code>、
        <code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">assets/</code> 三個慣例資料夾。
      </P>
