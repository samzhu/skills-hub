  ...
  return (
    <DocsLayout>
      ...
      <p className="mt-3 text-[15px] leading-relaxed text-[#A8A49C]">
        Skills Hub 用 Gemini text-embedding 把每個 skill 的 <code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[12px] text-[#EEECEA]">description</code>
      ...
      <ol className="mt-2 list-decimal space-y-1 pl-5 text-[14px] text-[#A8A49C]">
        ...
        <li>後端 <code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[12px] text-[#EEECEA]">SemanticSearchService</code> 將 query embed 成 768 維向量</li>
        <li>pgvector <code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[12px] text-[#EEECEA]">{`<#>`}</code> operator 計算 cosine similarity（轉 0–1 score）</li>
      ...
      <Callout>
        Embedding 模型版本：Gemini <code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[12px] text-[#EEECEA]">text-embedding-004</code>。
