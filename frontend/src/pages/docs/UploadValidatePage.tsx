  ...
  return (
    <DocsLayout>
      ...
      <p className="mt-3 text-[18px] leading-relaxed text-[#A8A49C]">
        Skills Hub 的發佈流程分四步：<strong className="text-[#EEECEA]">上傳 → 驗證 → 掃描 → 發佈結果</strong>。
        作者只負責第 1 步，其餘三步系統自動完成；風險等級會成為結果頁與安全報告上的提示。
      </p>
      ...
      <Step n={4} title="發佈結果" body="NONE/LOW/MEDIUM 顯示發佈完成（MEDIUM 附警告標）；HIGH 顯示高風險掃描完成，請查看安全報告或修正後重新上傳。" />
