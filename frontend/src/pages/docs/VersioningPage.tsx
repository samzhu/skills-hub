  ...
  return (
    <DocsLayout>
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5 text-[14px] text-[#A8A49C]">
        <li>格式：<code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">MAJOR.MINOR.PATCH</code>（如 <code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">1.0.0</code>），或附 pre-release tag（<code className="rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">2.0.0-rc.1</code>）</li>
      ...
      <Callout>
        ...
        <code className="ml-1 rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">/api/v1/skills/{'{id}'}/versions/1.0.0/download</code>
      </Callout>

      <H2>停用 / 下架</H2>
      <p className="mt-3 text-[14px] leading-relaxed text-[#A8A49C]">
        若整個 skill 需 emergency 下架（嚴重 bug / 違規），admin 可將 skill 設為
        <code className="mx-1 rounded bg-[#171719] px-1 py-0.5 font-mono text-[14px] text-[#EEECEA]">SUSPENDED</code>。
